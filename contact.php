...
<?php include "assets/includes/doctype.inc"; ?>
   ...
   <title>Contact us | <?php include "assets/includes/website-name.inc"; ?>
   </title>
         ...
         <div class="content center">
            ...
            <div id="contactForm">
               <form name="contactForm" action="contact.php" method="post" redirect="thankyou.php">
                  ...
                  <div class="subject">
                     <p>Subject</p>
                     <input name="subject" class="required" autocomplete="off">
                  </div>
            ...
            <div id="contactDetails">
               <div>
                  ...
                  <!--Smart Buttons-->
                  <div class="hide">
                     <a href="tel:233262691603">Tap to call us</a>
                     <a href="sms:233262691603">Tap to send us a SMS</a>
                  </div>
               </div>
               <!--Social Media Icons-->
